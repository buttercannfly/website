...
export const metadata: Metadata = {
    title: 'AIpex - clear cookies',
    description: 'With AIPex, you can clear cookies in one keyword shortcut',
    keywords: 'clear cookies, How to clear cookies on chrome, manage cookies',
    openGraph: {
      title: 'AIpex - clear cookies',
      description: 'With AIPex, you can clear cookies in one keyword shortcut',
      images: [{ url: 'With AIPex, you can clear cookies in one keyword shortcut' }],
    },
    twitter: {
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-100 to-white dark:from-purple-900 dark:to-gray-900">
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-16 pt-10">
          ...
          <p className="text-2xl text-gray-600 dark:text-gray-300 mb-8">
            <a href='https://aipex.quest'>
              With AIPex, clear your cookies with a simple keyboard shortcut
            </a>
          </p>
          <Button
            size="lg"
        ...
        <main>
                ...
                <Card className="relative bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                      How to clear cookies on Chrome? Press Command/Ctrl + M and type "cookies" - it's that simple!
                    </p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="mb-24">
            <h2 className="text-4xl font-bold mb-12 text-center text-gray-800 dark:text-white">
              How to Clear Cookies with AIPex?
            </h2>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2 dark:text-white">Type "cookies"</h3>
                      <p className="text-gray-600 dark:text-gray-300">
                        Simply type "cookies" to instantly clear your browser cookies
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <p className="ml-3 text-sm text-gray-600 dark:text-gray-300">
                      <span className="font-medium">Pro tip:</span> You can use this shortcut to quickly clear your cookies whenever you need a fresh start
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-24">
            ...
            >
              {[
                {
                  "question": "What's the shortcut key to clear cookies in Chrome using AIPex?",
                  "answer": "With AIPex, clearing cookies is as simple as pressing Command+M and typing 'cookies'. This quick keyboard shortcut makes cookie management effortless and instantaneous."
                },
                {
                  "question": "How to clear cookies on Chrome with AIPex?",
                  "answer": "AIPex's cookie clearing feature offers a more streamlined experience with a single keyboard shortcut (Command+M). Unlike Chrome's traditional methods, AIPex makes the process faster and more intuitive."
                },
                {
                  "question": "Can I clear cookies for specific sites with AIPex?",
                  "answer": "Yes, AIPex allows you to efficiently clear cookies for specific sites. Simply use Command+M and type 'cookies' for the site you want to clear. The process is quick and seamless."
                },
                {
                  "question": "Is AIPex's cookie clearing feature free to use?",
                  "answer": "Yes, AIPex's cookie clearing feature is completely free. You can clear cookies using the Command+M shortcut without any subscription or hidden costs."
                },
                {
                  "question": "Why should I use AIPex for clearing cookies?",
                  "answer": "AIPex offers the fastest and most convenient way to clear cookies with just Command+M and typing 'cookies'. This simple approach, combined with its reliability and efficiency, makes it the ideal choice for users who frequently need to manage their cookies."
                }
              ].map((item, index) => (
        ...
        <footer className="text-center text-gray-600 dark:text-gray-400 py-6">
          <div className="mb-4">
            <p className="mb-3">
              &copy; 2024 AIPex - The Best Cookie Manager Extension for Google Chrome. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
