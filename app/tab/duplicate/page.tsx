...
export const metadata: Metadata = {
    title: 'AIpex - duplicate tabs',
    description: ' With AIPex, you can duplicate tab in one keyword shorcut',
    keywords: 'duplicate tab, How to duplicate tab on chrome, organize tabs',
    openGraph: {
      title: 'AIpex - duplicate tabs',
      description: 'With AIPex, you can duplicate tabs in one keyword shorcut',
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-100 to-white dark:from-purple-900 dark:to-gray-900">
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-16 pt-10">
          <div className="relative inline-block">
            ...
            <h1 className="text-6xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 relative">
              How to duplicate tabs in Chrome?
            </h1>
          </div>
          <p className="text-2xl text-gray-600 dark:text-gray-300 mb-8">
            <a href='https://aipex.quest'>
              With AIPex, duplicate any tab with a simple keyboard shortcut
            </a>
          </p>
          <Button
            size="lg"
        ...
        <main>
                ...
                <Card className="relative bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="text-2xl font-semibold text-gray-800 dark:text-white">
                      duplicate tabs on chrome
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="relative w-full h-120 overflow-hidden rounded-lg">
                      <img
                        src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*YYD1PgDu6Jr_TTy-Et8zBA.gif"
                        alt="duplicate tab"
                        className="w-full h-full object-cover object-center transition-transform duration-300 group-hover:scale-105"
                      />
                    </div>
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                      How to duplicate tabs on Chrome? Press Command/Ctrl + M and type "duplicate" - it's that simple!
                    </p>
                  </CardContent>
                </Card>
              </div>
          ...
          <section className="mb-24">
            <h2 className="text-4xl font-bold mb-12 text-center text-gray-800 dark:text-white">
              How to Duplicate Tabs with AIPex?
            </h2>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2 dark:text-white">Type "duplicate"</h3>
                      <p className="text-gray-600 dark:text-gray-300">
                        Simply type "duplicate" to instantly create a copy of your current tab
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <p className="ml-3 text-sm text-gray-600 dark:text-gray-300">
                      <span className="font-medium">Pro tip:</span> You can use this shortcut on any tab to quickly create duplicates for multitasking or comparison
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-24">
            <h2 className="text-4xl font-bold mb-12 text-center text-gray-800 dark:text-white">
              Frequently Asked Questions about duplicating tabs
            </h2>
            <Accordion
              type="single"
              collapsible
            ...
            >
              {[
                {
                  "question": "How can I quickly duplicate tabs in Chrome using AIPex?",
                  "answer": "With AIPex, duplicating tabs is as simple as pressing Command+M and typing 'duplicate'. This quick keyboard shortcut makes tab duplication effortless and instantaneous."
                },
                {
                  "question": "What makes AIPex's duplicate tab feature better than Chrome's built-in options?",
                  "answer": "AIPex's duplicate tab feature offers a more streamlined experience with a single keyboard shortcut (Command+M). Unlike Chrome's right-click method or manual copying of URLs, AIPex makes the process faster and more intuitive."
                },
                {
                  "question": "Can I duplicate multiple tabs at once with AIPex?",
                  "answer": "Yes, AIPex allows you to efficiently duplicate multiple tabs. Simply use Command+M and type 'duplicate' for each tab you want to copy. The process is quick and seamless."
                },
                {
                  "question": "Is AIPex's duplicate tab feature free to use?",
                  "answer": "Yes, AIPex's duplicate tab feature is completely free. You can duplicate unlimited tabs using the Command+M shortcut without any subscription or hidden costs."
                },
                {
                  "question": "Why should I use AIPex for duplicating tabs?",
                  "answer": "AIPex offers the fastest and most convenient way to duplicate tabs with just Command+M and typing 'duplicate'. This simple approach, combined with its reliability and efficiency, makes it the ideal choice for users who frequently work with multiple tabs."
                }
              ].map((item, index) => (
